...
<head>
	...
	<title>GB - Agência de Marketing Digital </title>
	<meta charset="utf-8">
...
<body>
	...
	<section class="descricao-danki" id="sobre">
		<div class="container">
		<p>Com anos de experiência em desenvolvimento web e automação de marketing, a <b>GB-Developers</b> traz soluções que ajudam o seu time a vender mais tanto em segmentos B2C quanto B2B.</p>
		</div>
	</section>
	...
	<section class="descricao-danki3">
		<div class="container">
			<div class="box-depoimento">
				<p>“Temos o GB como parceiro estratégico nos nossos planejamento em plataforma digital. Sempre nos trazendo soluções inovadoras e adequadas às nossas necessidades e dos nossos clientes. Super recomendo!“</p>
				<br/>
			...
			<div class="space-servico">
				...
				<img src="images/img6.jpg" />	
						<div class="box-servico-wraper">
							...
							<p>Precisa de ajuda e planejamento de marketing no seu negócio? Fale com a GB Developers, hoje mesmo, para
	...
	<footer>
		<div class="container">
			<div class="box-footer">
				<h2>Endereço</h2>
				<p>Rua Estrada Nova, 328 - Mauá, Magé/RJ, Brasil</p>
			</div>
			<div class="box-footer">
				<h2>Telefone</h2>
				<p>(21)99999-9999</p>
